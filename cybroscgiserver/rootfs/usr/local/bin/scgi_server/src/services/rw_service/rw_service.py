...
class RWService:
    ...
    async def _process_plc_requests(self, r_requests_by_nad, w_requests_by_nad, task_id):
    ...
    def _generate_coroutines_for_plc_requests(self, r_requests_by_nad, w_requests_by_nad, task_id):
