...
class PlcHead:
    ...
    def __str__(self):
        return f"empty={self.empty}, magic={self.magic}, crc={self.crc}, " \
...
def bytes_to_plc_head(data_bytes):
    ...
    file_system_info_bytes = \
        data_bytes[FILE_SYSTEM_INFO_OFFSET: FILE_SYSTEM_INFO_OFFSET + FILE_SYSTEM_INFO_SIZE]

    scan_overrun_bytes = data_bytes[SCAN_OVERRUN_OFFSET: SCAN_OVERRUN_OFFSET+SCAN_OVERRUN_SIZE]
