...
from services.rw_service.subservices.plc_comm_service.alc_service.var_info import VarInfo
from services.rw_service.subservices.plc_comm_service.data_type import DataType, DATA_TYPE_SIZES
