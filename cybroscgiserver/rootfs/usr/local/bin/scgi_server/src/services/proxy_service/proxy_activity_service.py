...
class ProxyActivityService:
    ...
    def report_to_plc(self, session_id, nad):
        plc_proxy_activity = self.plc_proxy_activities_by_session_id.get(session_id, None)
    ...
    async def update_from_db(self):
        ...
        session_ids_from_db = await self._repository.get_enabled_with_session_id_in(proxy_plc_infos_session_ids)
