...
from config.data_logger_config.data_logger_config import DataLoggerConfig, MeasurementTask, Target, \
    AlarmPriority, AlarmRange, AlarmTask, TaskType
from config.errors import DataLoggerXmlParserError, UnexpectedTagError, MissingTagError
...
def _parse_alarm_task(task_element, type):
    ...
    return AlarmTask(period, targets, enabled, alarm_class, priority, alarm_range, message, task_type)
