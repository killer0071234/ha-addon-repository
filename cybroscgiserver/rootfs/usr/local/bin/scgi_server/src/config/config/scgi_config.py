...
class ScgiConfig:
    ...
    def load(cls, cp, default):
        ...
        scgi_bind_addr_from_conf = cp.get(section, "bind_address", fallback=scgi_bind_address)
        ...
        return cls(
            ...
            cp.getboolean(section, "reply_with_descriptions", fallback=reply_with_descriptions),
