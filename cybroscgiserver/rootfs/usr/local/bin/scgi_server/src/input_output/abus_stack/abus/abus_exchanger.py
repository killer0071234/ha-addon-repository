...
class AbusExchanger:
    ...
    def receive(self, abus_msg):
        exchange_tags_match = \
            self._extract_exchange_tag_from_response(abus_msg) == self._last_exchange_tag
    ...
    def _extract_exchange_tag_from_response(abus_response):
        return abus_response.to_nad, abus_response.from_nad, abus_response.transaction_id
